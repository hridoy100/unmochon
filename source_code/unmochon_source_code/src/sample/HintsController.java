                            ...
                            public void run() {
                                ...
                                stage.widthProperty().addListener((ChangeListener<? super Number>) new ChangeListener<Number>() {
                                    ...
                                    public void changed(ObservableValue<? extends Number> arg0, Number arg1, Number arg2) {
                                        ...
                                        root.setScaleY(Math.min(root.getWidth()/width,root.getHeight()/height));
                                        root.setScaleX(Math.min(root.getWidth()/width,root.getHeight()/height));
