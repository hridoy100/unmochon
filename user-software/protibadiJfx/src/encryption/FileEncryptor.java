...
public class FileEncryptor {
    ...
    public static void main(String[] args) {
        ...
        try {
            encryptFile("2021-09-23 02 27 12.jpg", "password");
            decryptFile("2021-09-23 02 27 12", "password");
        } catch (IOException e) {
    ...
    public static void decryptFile(String fileName, String pass)
        ...
        FileOutputStream target = new FileOutputStream(new File(fileName + ".decrypted.jpg"));
